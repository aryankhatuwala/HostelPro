...
function Sidebar({ links }) {
  ...
  return (
    <div>
      ...
      <div
       className={`flex flex-col justify-between h-screen w-screen absolute md:static sm:w-64 bg-black text-white transition-transform duration-300 ease-in-out z-40 transform border-r border-white ${
      ...
      >
        <Link
         ...
         className="py-4 px-4 md:py-5 lg:py-4 gap-2 bg-blue-700 flex items-center text-2xl rounded p-[1rem] border border-black"
