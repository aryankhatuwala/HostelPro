...
function Topbar({ name, notifications }) {
  ...
  return (
    <div className="py-5 px-5 flex items-center justify-between text-white w-full bg-black shadow-lg absolute top-0 md:w-[83.3vw] md:ml-[16.7vw] border-b border-white" >
