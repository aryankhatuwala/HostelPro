...
function Mess() {
  ...
  const labels = ["Leave approved", "Leave Requests", "Non-leave Days"];
  const loader = (
    <svg
      aria-hidden="true"
  ...
  return (
    ...
    <div className="w-full h-screen gap-10 flex flex-col items-center justify-center max-h-screen overflow-y-auto pt-[500px] sm:pt-96 md:pt-96 lg:pt-40">
      <h1 className="text-white font-bold text-5xl">Leave Request</h1>
      <ul className="flex gap-5 text-white text-xl px-5 sm:p-0 text-center">
        <li>Total Days: {daysofmonthtilltoday - Messoff} </li>
        <li>Leaves Taken: {loading ? loader : Messoff}</li>
        ...
        <div className="h-[30vh] gap-2 flex items-center justify-center flex-wrap">
          ...
          <ul className="text-white">
            <li className="flex gap-2">
              {" "}
              <span className="w-10 h-5 bg-orange-500 block"></span> Leaves Taken
            </li>
            <li className="flex gap-2">
              {" "}
              <span className="w-10 h-5 bg-yellow-500 block"></span> Leave Requests
            </li>
            <li className="flex gap-2">
              {" "}
              <span className="w-10 h-5 bg-blue-500 block"></span> Working Days
            </li>
          </ul>
        </div>
