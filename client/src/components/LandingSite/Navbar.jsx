...
function Navbar() {
  ...
  const mobileMenuStyles = `flex-col absolute top-0 left-0 w-full h-full bg-gray px-10 bg-black py-40 text-xl font-bold`;

  return (
    <nav className="flex align-center justify-between p-10 text-white md:px-20 bg-gray-900 text-xl">
